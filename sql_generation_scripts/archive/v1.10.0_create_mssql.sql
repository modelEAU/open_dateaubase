-- Baseline CREATE script for schema v1.10.0
-- Platform: mssql
-- Generated: 2026-02-23 20:58:52 UTC
...
CREATE TABLE [dbo].[MetaData] (
    ...
    [StatusOfMetaDataID] INT,
    [StatusOfEquipmentID] INT,
    CONSTRAINT [PK_MetaData] PRIMARY KEY ([Metadata_ID]),
    CONSTRAINT [CK_MetaData_StatusTarget] CHECK (NOT (StatusOfMetaDataID IS NOT NULL AND StatusOfEquipmentID IS NOT NULL))
);
...
CREATE UNIQUE INDEX [UQ_MetaData_SensorStream] ON [dbo].[MetaData] ([Equipment_ID], [Parameter_ID], [DataProvenance_ID], [ProcessingDegree]);
...
ALTER TABLE [dbo].[MetaData] ADD CONSTRAINT [FK_MetaData_MetaData] FOREIGN KEY ([StatusOfMetaDataID]) REFERENCES [dbo].[MetaData] ([Metadata_ID]);
ALTER TABLE [dbo].[MetaData] ADD CONSTRAINT [FK_MetaData_Equipment] FOREIGN KEY ([StatusOfEquipmentID]) REFERENCES [dbo].[Equipment] ([Equipment_ID]);
