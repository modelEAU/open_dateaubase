...
-- Platform: mssql
-- Generated: 2026-03-30 23:56:04 UTC
...
CREATE TABLE [dbo].[PortEquipmentHistory] (
    [PortEquipmentHistory_ID] INT IDENTITY(1,1) NOT NULL,
    [SignalPort_ID] INT NOT NULL,
    [Equipment_ID] INT,
    [StartTime] DATETIME2(7) NOT NULL,
    [EndTime] DATETIME2(7),
    [Notes] NVARCHAR(MAX),
    CONSTRAINT [PK_PortEquipmentHistory] PRIMARY KEY ([PortEquipmentHistory_ID])
);
...
CREATE UNIQUE INDEX [UQ_PortEquipmentHistory_ActiveRow] ON [dbo].[PortEquipmentHistory] ([SignalPort_ID]);
...
ALTER TABLE [dbo].[PortEquipmentHistory] ADD CONSTRAINT [FK_PortEquipmentHistory_SignalPort] FOREIGN KEY ([SignalPort_ID]) REFERENCES [dbo].[SignalPort] ([SignalPort_ID]);
ALTER TABLE [dbo].[PortEquipmentHistory] ADD CONSTRAINT [FK_PortEquipmentHistory_Equipment] FOREIGN KEY ([Equipment_ID]) REFERENCES [dbo].[Equipment] ([Equipment_ID]);
