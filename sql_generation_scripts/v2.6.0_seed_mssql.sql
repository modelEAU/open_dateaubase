-- Seed data for schema v2.6.0
-- Platform: mssql
-- Generated: 2026-08-04 15:09:13 UTC
-- AnnotationKind
...
INSERT INTO [dbo].[EquipmentKind] ([EquipmentKind_ID], [Name], [Description]) VALUES (1, N'Online sensor', N'Device measuring in place and emitting a continuous signal.');
INSERT INTO [dbo].[EquipmentKind] ([EquipmentKind_ID], [Name], [Description]) VALUES (2, N'Offline analyzer', N'Instrument analyzing samples brought to it, in the field or in a laboratory.');
INSERT INTO [dbo].[EquipmentKind] ([EquipmentKind_ID], [Name], [Description]) VALUES (3, N'Sampler', N'Device collecting physical samples for later analysis.');
INSERT INTO [dbo].[EquipmentKind] ([EquipmentKind_ID], [Name], [Description]) VALUES (4, N'Other', N'Equipment type not covered by the other categories.');
...
INSERT INTO [dbo].[OperationKind] ([OperationKind_ID], [Name], [Description]) VALUES (6, N'Interpolation', N'Missing values filled from observations bracketing the gap on both sides');
INSERT INTO [dbo].[OperationKind] ([OperationKind_ID], [Name], [Description]) VALUES (7, N'Reconstruction', N'Values generated where no bracketing observation existed — from a model, a correlated channel or a seasonal profile');
-- ProcedureKind
...
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (1, N'Structural', N'Area', N'Broad spatial zone grouping other units (e.g. biological treatment area)');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (2, N'Structural', N'Zone', N'Defined functional sub-zone within a process area');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (3, N'Structural', N'Tank', N'Generic enclosed vessel — prefer a Treatment term where one describes what the tank is for');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (9, N'Structural', N'Basin', N'Generic open or partially open containment structure — prefer a Treatment term where one applies');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (12, N'Structural', N'Train', N'One parallel process line through a plant, grouping the units that treat a shared share of the flow');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (13, N'Structural', N'Storage tank', N'Vessel holding liquid for later use or discharge, with no treatment intended');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (14, N'Structural', N'Equalization basin', N'Basin buffering flow or load variation so downstream units see a steadier feed');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (4, N'Treatment', N'Reactor', N'Generic vessel for controlled biological or chemical reaction — prefer a specific reactor term where one applies');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (8, N'Treatment', N'Clarifier', N'Gravity settling vessel separating solids from liquid. Whether it is primary or secondary is recorded as the unit''s treatment stage, not as its kind');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (15, N'Treatment', N'Aerated activated sludge reactor', N'Activated sludge reactor designed to be aerated, holding a suspended culture in contact with oxygen. Design intent — the oxygen actually present is a measurement');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (16, N'Treatment', N'Anoxic activated sludge reactor', N'Activated sludge reactor designed to run without aeration on nitrate as electron acceptor, typically for denitrification');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (17, N'Treatment', N'Anaerobic activated sludge reactor', N'Activated sludge reactor designed to run free of both oxygen and nitrate, typically for biological phosphorus release');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (18, N'Treatment', N'Sequencing batch reactor', N'Single vessel cycling fill, react, settle and decant in time rather than separating them in space');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (19, N'Treatment', N'Membrane bioreactor', N'Activated sludge reactor whose biomass is retained by a membrane instead of by a settling stage');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (20, N'Treatment', N'Digester', N'Vessel stabilising sludge by microbial degradation of its biodegradable organic content, anaerobically producing biogas or aerobically consuming oxygen');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (21, N'Treatment', N'Thermal hydrolysis unit', N'Unit conditioning sludge under heat and pressure to improve its digestibility and dewaterability (e.g. a Cambi installation)');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (22, N'Treatment', N'Screen', N'Bar rack or perforated surface retaining solids too large to pass, cleared by raking or brushing');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (23, N'Treatment', N'Grit chamber', N'Chamber settling dense inorganic particles at a controlled velocity that keeps lighter organic solids in suspension');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (24, N'Treatment', N'Dissolved-air flotation unit', N'Unit separating solids by attaching fine air bubbles so they rise and are skimmed off');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (25, N'Treatment', N'Membrane module', N'Unit separating a feed into permeate and retentate across a semi-permeable barrier');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (26, N'Treatment', N'UV reactor', N'Unit inactivating pathogens by exposing a stream to ultraviolet irradiation at a design dose');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (27, N'Treatment', N'Contact basin', N'Basin holding a stream in contact with a dosed disinfectant for a design detention time');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (28, N'Treatment', N'Thickener', N'Unit concentrating sludge solids ahead of digestion or dewatering');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (29, N'Treatment', N'Dewatering unit', N'Unit removing water from sludge mechanically (centrifuge, belt or filter press, screw press)');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (5, N'Conveyance', N'Pipe', N'Conduit transporting liquid between process units');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (6, N'Conveyance', N'Pump', N'Mechanical device for moving liquid');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (7, N'Conveyance', N'Valve', N'Flow control device regulating liquid passage');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (10, N'Conveyance', N'Blower', N'Mechanical device for supplying air or gas');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (30, N'Conveyance', N'Weir', N'Overflow structure setting a level or measuring a flow');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (31, N'Conveyance', N'Splitter box', N'Structure dividing one flow between two or more downstream units');
INSERT INTO [dbo].[ProcessUnitKind] ([ProcessUnitKind_ID], [Category], [Name], [Description]) VALUES (11, NULL, N'Other', N'Process unit kind not covered by the standard vocabulary');
...
INSERT INTO [dbo].[TreatmentStage] ([TreatmentStage_ID], [SortOrder], [Name], [Description]) VALUES (1, 1, N'Preliminary', N'Removes the gross solids, rags and grit that would damage or foul the units downstream');
INSERT INTO [dbo].[TreatmentStage] ([TreatmentStage_ID], [SortOrder], [Name], [Description]) VALUES (2, 2, N'Primary', N'Removes settleable and floatable material from a raw stream by physical means, ahead of any biological step');
INSERT INTO [dbo].[TreatmentStage] ([TreatmentStage_ID], [SortOrder], [Name], [Description]) VALUES (3, 3, N'Secondary', N'Removes dissolved and colloidal organic matter biologically, together with the separation of the biomass this produces');
INSERT INTO [dbo].[TreatmentStage] ([TreatmentStage_ID], [SortOrder], [Name], [Description]) VALUES (4, 4, N'Tertiary', N'Polishes a secondary effluent — residual solids, nutrients, micropollutants or pathogens — beyond what the secondary stage achieves');
INSERT INTO [dbo].[TreatmentStage] ([TreatmentStage_ID], [SortOrder], [Name], [Description]) VALUES (5, 5, N'Sludge line', N'Treats the solids drawn off the water line rather than the water itself');
