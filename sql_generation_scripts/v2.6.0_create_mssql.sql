...
-- Platform: mssql
-- Generated: 2026-07-06 15:09:19 UTC
...
VALUES (N'2.6.0', N'ControlLoopPort now references Stream (any time-series identity — a sensor Channel or a lab AnalysisSeries) instead of Channel: column Channel_ID → Stream_ID with FK to Stream, and unique index renamed to UQ_ControlLoopPort_LoopStream. A control loop can now wire lab streams, not just sensor channels. Pre-release, fresh install only — no migration.');
