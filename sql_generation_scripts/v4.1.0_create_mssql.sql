...
ALTER TABLE [dbo].[Parameter] ADD CONSTRAINT [FK_Parameter_ValueKind] FOREIGN KEY ([ValueKind_ID]) REFERENCES [dbo].[ValueKind] ([ValueKind_ID]);
ALTER TABLE [dbo].[ParameterHasUnit] ADD CONSTRAINT [FK_ParameterHasUnit_Parameter] FOREIGN KEY ([Parameter_ID]) REFERENCES [dbo].[Parameter] ([Parameter_ID]);
ALTER TABLE [dbo].[ParameterHasUnit] ADD CONSTRAINT [FK_ParameterHasUnit_Unit] FOREIGN KEY ([Unit_ID]) REFERENCES [dbo].[Unit] ([Unit_ID]);
