-- ============================================================
-- Seed data for schema v2.2.0
-- Scenario: Wastewater and stormwater monitoring in Quebec City
--
-- Timestamps are UTC throughout.
-- Uses Observation hub pattern - all values linked via Observation_ID
-- ============================================================
...
--
-- In v2.2.0, we insert into Observation first to get Observation_ID,
-- then insert the payload into the appropriate value table.
-- ============================================================

-- Scalar Values via Observation hub
-- ISCO TSS at WWTP inlet (Channel_ID=1)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (1, '2024-01-15T13:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 185.0);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (1, '2024-01-15T19:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 210.5);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (1, '2024-01-16T13:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 192.3);

-- ISCO COD 24h composite (Channel_ID=2)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (2, '2024-01-15T05:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 450.0);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (2, '2024-01-16T05:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 520.8);

-- YSI pH online continuous (Channel_ID=3)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (3, '2024-01-15T05:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 7.2);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (3, '2024-01-15T09:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 7.1);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (3, '2024-01-15T13:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 6.9);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (3, '2024-01-15T17:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 7.8);

-- ISCO TSS at CSO outfall (Channel_ID=1)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (1, '2024-03-20T12:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 350.0);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (1, '2024-03-20T14:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 580.2);

-- Note: Changed timestamp from 14:00:00 to 14:01:00 to avoid duplicate key with previous insert
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (1, '2024-03-20T14:01:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 345.0);

-- Effluent TSS manual entry (Channel_ID=5)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (5, '2024-01-15T13:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 12.5);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (5, '2024-01-16T13:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 15.0);

-- YSI Temperature online (Channel_ID=4)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (4, '2024-01-15T05:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 12.3);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (4, '2024-01-15T09:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 12.1);

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (4, '2024-01-15T13:00:00', 'Scalar');
INSERT INTO [dbo].[Value] ([Observation_ID], [Value]) VALUES (SCOPE_IDENTITY(), 11.8);

-- Device status values: ISCO-001 operational (Channel_ID=10, code 1=Operational)
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (10, '2024-01-11T08:00:00', 'Scalar');
...
-- ValueVector: UV-Vis spectrum (Channel_ID=6) - First timestamp
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (6, '2025-09-10T14:00:00', 'Vector');
DECLARE @obs6a BIGINT = SCOPE_IDENTITY();
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 1, 2.85, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 2, 2.42, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 3, 1.15, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 4, 0.45, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 5, 0.12, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 6, 0.05, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6a, 7, 0.02, NULL);

-- ValueVector: UV-Vis spectrum (Channel_ID=6) - Second timestamp
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (6, '2025-09-10T18:00:00', 'Vector');
DECLARE @obs6b BIGINT = SCOPE_IDENTITY();
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6b, 1, 3.10, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6b, 2, 2.68, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs6b, 3, 1.35, 1);

-- ValueVector: particle size distribution (Channel_ID=8) - First timestamp
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (8, '2025-09-10T13:00:00', 'Vector');
DECLARE @obs8a BIGINT = SCOPE_IDENTITY();
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8a, 8,  45.2, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8a, 9,  28.1, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8a, 10, 12.5, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8a, 11,  5.8, NULL);

-- ValueVector: particle size distribution (Channel_ID=8) - Second timestamp
INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (8, '2025-09-10T17:00:00', 'Vector');
DECLARE @obs8b BIGINT = SCOPE_IDENTITY();
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8b, 8,  52.0, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8b, 9,  33.4, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8b, 10, 15.1, NULL);
INSERT INTO [dbo].[ValueVector] ([Observation_ID], [ValueBin_ID], [Value], [QualityCode]) VALUES (@obs8b, 11,  7.2, NULL);

-- ============================================================
-- Image Values via Observation hub
-- ============================================================

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (7, '2025-09-10T16:00:00', 'Image');
INSERT INTO [dbo].[ValueImage] ([Observation_ID], [ImageWidth], [ImageHeight], [NumberOfChannels], [ImageFormat], [FileSizeBytes], [StorageBackend], [StoragePath])
VALUES (SCOPE_IDENTITY(), 1920, 1080, 3, N'JPEG', 245760, N'FileSystem', N'/images/cso12/2025-09-10_160000.jpg');

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (7, '2025-09-10T16:15:00', 'Image');
INSERT INTO [dbo].[ValueImage] ([Observation_ID], [ImageWidth], [ImageHeight], [NumberOfChannels], [ImageFormat], [FileSizeBytes], [StorageBackend], [StoragePath])
VALUES (SCOPE_IDENTITY(), 1920, 1080, 3, N'JPEG', 251904, N'FileSystem', N'/images/cso12/2025-09-10_161500.jpg');

-- ============================================================
-- Matrix Values via Observation hub
-- ============================================================

INSERT INTO [dbo].[Observation] ([Channel_ID], [Timestamp], [DataType]) VALUES (9, '2025-09-10T13:00:00', 'Matrix');
DECLARE @obs9 BIGINT = SCOPE_IDENTITY();
INSERT INTO [dbo].[ValueMatrix] ([Observation_ID], [RowValueBin_ID], [ColValueBin_ID], [Value]) VALUES (@obs9, 8,  12, 22.1);
INSERT INTO [dbo].[ValueMatrix] ([Observation_ID], [RowValueBin_ID], [ColValueBin_ID], [Value]) VALUES (@obs9, 8,  13, 23.1);
INSERT INTO [dbo].[ValueMatrix] ([Observation_ID], [RowValueBin_ID], [ColValueBin_ID], [Value]) VALUES (@obs9, 9,  12, 15.0);
INSERT INTO [dbo].[ValueMatrix] ([Observation_ID], [RowValueBin_ID], [ColValueBin_ID], [Value]) VALUES (@obs9, 9,  13, 13.1);
INSERT INTO [dbo].[ValueMatrix] ([Observation_ID], [RowValueBin_ID], [ColValueBin_ID], [Value]) VALUES (@obs9, 10, 12,  6.3);
INSERT INTO [dbo].[ValueMatrix] ([Observation_ID], [RowValueBin_ID], [ColValueBin_ID], [Value]) VALUES (@obs9, 10, 13,  6.2);

-- ============================================================
-- TIER 7: Lab Analysis and Annotations
-- ============================================================
