...
:r /sql_generation_scripts/v2.5.0_create_mssql.sql
GO
...
-- ProcessUnitKind, SampleKind, SampleMaterialKind, SampleCollectionKind,
-- EquipmentKind, Unit,
-- Parameter, ParameterHasUnit.
:r /sql_generation_scripts/v2.5.0_seed_mssql.sql
GO
