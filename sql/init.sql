...
:r /sql_generation_scripts/v2.6.0_create_mssql.sql
GO

-- Vocabulary seed (auto-generated from YAML seed_data fields):
-- ValueKind, ChannelKind, DataProvenanceKind, OperationKind, StreamKind,
...
-- ProcessUnitKind, TreatmentStage, SampleKind, SampleMaterialKind,
-- SampleCollectionKind, EquipmentKind, Unit,
-- Parameter, ParameterHasUnit.
:r /sql_generation_scripts/v2.6.0_seed_mssql.sql
GO
