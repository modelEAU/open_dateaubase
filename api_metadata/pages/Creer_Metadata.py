...
def _select_or_create(label: str, lookup_path: str, key: str):
    ...
    Le bouton 'Créer' est hors form — compatible Streamlit.
...
def main():
    ...
    # --- Selectboxes hors form (pour permettre les boutons "Créer") ---
    st.markdown("### Champs")
    ...
    with col2:
        sampling_point_id = _select_or_create("Point d'échantillonnage", "/lookups/sampling_points",  "sampling")
        ...
        condition_id      = _select_or_create("Condition météo",        "/lookups/weather_condition", "condition")
